...
class PlotsManager {
	...
	constructor (plotsNumber, height, width) {
	  this._height = height
	  this._width = width
	  this._plotsNumber = plotsNumber || 2
	  this.positions = []
	  this.initLayout()
	}
...
class ChartSet {
  ...
  draw () {
    console.log('draw', this.chartDm, this.chartDm.left_id, this.chartDm.right_id)

  ...
  export default {
    data () {
      return {
        ...
        quote: this.$tqsdk.get({ name: 'quote', symbol: this.instrumentId })
      }
    },
    mounted: function () {
    ...
    watch: {
      instrumentId: {
        handler (newVal, oldVal) {
          ...
          this.quote = this.$tqsdk.get({ name: 'quote', symbol: newVal })
        },
        immediate: true
      }
    },
    ...
    methods: {
      ...
      update: function () {
        ...
        this.quote = this.$tqsdk.get({ name: 'quote', symbol: this.instrumentId })
        this.$forceUpdate()
      }
    }
  }
